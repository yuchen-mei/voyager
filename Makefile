...
test/compiler/networks/resnet18/params.pb: quantized-training/test/test_codegen.py
	python quantized-training/test/test_codegen.py --model resnet18 --output_dir test/compiler/networks/resnet18
test/compiler/networks/resnet50/params.pb: quantized-training/test/test_codegen.py
	python quantized-training/test/test_codegen.py --model resnet50 --output_dir test/compiler/networks/resnet50
