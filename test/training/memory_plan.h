...
#define CLASSIFIER_B (CLASSIFIER_W + CLASSIFIER_W_SIZE)
#define CLASSIFIER_B_SIZE (16 * 2)
#define LORA_G (CLASSIFIER_B + CLASSIFIER_B_SIZE)
#define LORA_G_SIZE (LORA_W_SIZE)
#define CLASSIFIER_G (LORA_G + LORA_G_SIZE)
#define CLASSIFIER_G_SIZE (CLASSIFIER_W_SIZE)
#define CLASSIFIER_B_G (CLASSIFIER_G + CLASSIFIER_G_SIZE)
#define MAX_GRAD (CLASSIFIER_B_G + CLASSIFIER_B_SIZE)
