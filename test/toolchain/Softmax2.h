...
void MapSoftmax(const codegen::Operation &param,
  ...
  vector_instruction_config->instLoopCount = reduced_size;
  ...
  vector_instruction_config->instCount[0] = outer_dim / OC_DIMENSION;

  vector_instruction_config->instLen = 1;
  vector_instruction_config->instLoopCount = input_inner_dim;
