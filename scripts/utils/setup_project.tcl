...
solution options set Input/CompilerFlags "-D$DATATYPE -DACCUM_DATATYPE=DataTypes::$ACCUM_DATATYPE_NAME -DIC_DIMENSION=$IC_DIMENSION -DOC_DIMENSION=$OC_DIMENSION -DINPUT_BUFFER_SIZE=$INPUT_BUFFER_SIZE -DWEIGHT_BUFFER_SIZE=$WEIGHT_BUFFER_SIZE -DACCUM_BUFFER_SIZE=$ACCUM_BUFFER_SIZE -DDOUBLE_BUFFERED_ACCUM_BUFFER=$DOUBLE_BUFFERED_ACCUM_BUFFER -DSUPPORT_MVM=$SUPPORT_MVM -DSUPPORT_SPMM=$SUPPORT_SPMM -DSUPPORT_DWC=$SUPPORT_DWC -DCLOCK_PERIOD=$CLOCK_PERIOD -DVOYAGER_WEIGHT_FETCHER_FIFO_DEPTH=$VOYAGER_WEIGHT_FETCHER_FIFO_DEPTH -DVOYAGER_INPUT_FETCHER_FIFO_DEPTH=$VOYAGER_INPUT_FETCHER_FIFO_DEPTH"
...
solution options set Flows/VCS/COMP_FLAGS "-O3 -Wall -Wno-unknown-pragmas -I$ROOT/lib/ -I$ROOT/lib/xtensor/include -I$ROOT/lib/xtl/include -I$ROOT/lib/spdlog/include -I$ROOT/src/ -I$ROOT/ -I$::env(CONDA_PREFIX)/include -DSIM_$BLOCK -D$DATATYPE -DACCUM_DATATYPE=DataTypes::$ACCUM_DATATYPE_NAME -DIC_DIMENSION=$IC_DIMENSION -DOC_DIMENSION=$OC_DIMENSION -DINPUT_BUFFER_SIZE=$INPUT_BUFFER_SIZE -DWEIGHT_BUFFER_SIZE=$WEIGHT_BUFFER_SIZE -DACCUM_BUFFER_SIZE=$ACCUM_BUFFER_SIZE -DDOUBLE_BUFFERED_ACCUM_BUFFER=$DOUBLE_BUFFERED_ACCUM_BUFFER -DSUPPORT_MVM=$SUPPORT_MVM -DSUPPORT_DWC=$SUPPORT_DWC -DVOYAGER_WEIGHT_FETCHER_FIFO_DEPTH=$VOYAGER_WEIGHT_FETCHER_FIFO_DEPTH -DVOYAGER_INPUT_FETCHER_FIFO_DEPTH=$VOYAGER_INPUT_FETCHER_FIFO_DEPTH -std=c++17"
