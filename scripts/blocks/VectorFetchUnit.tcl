...
proc pre_architect {} {
  ...
  directive set /$vector_fetch_unit_stripped/$vector_fetch_unit_stripped:feed_data_response_0/feed_data_response_0/while:if:buffer.float_val.d:rsc -MAP_TO_MODULE {[Register]}
}
