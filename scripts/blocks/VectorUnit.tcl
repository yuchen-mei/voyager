...
set full_block_name "VectorUnit<$VECTOR_DATATYPE, $ACCUM_BUFFER_DATATYPE, $SCALE_DATATYPE, $VECTOR_UNIT_WIDTH, $REDUCER_WIDTH, $ACCUMULATOR_WIDTH, $OC_DIMENSION, $OC_PORT_WIDTH>"
